  ...
  return (
    <div className="flex flex-col gap-16">
      <div className="flex flex-col gap-8">
        <h2 className="text-2xl text-[#0BB489] font-poppins font-normal">
          Dettagli veicolo
        </h2>
        <span className="text-base font-poppins font-light">{car.name}</span>
        <div className="grid grid-cols-2 w-full gap-8">
          <div>
            <h5 className="text-base font-poppins font-medium">Riferimento</h5>
            <span className="text-base font-poppins font-light">
              {car.details?.riferimento ? car.details.riferimento : "-"}
            </span>
          </div>
          <div>
            <h5 className="text-base font-poppins font-medium">VIN</h5>
            <span className="text-base font-poppins font-light">
              {car.details?.vin ? car.details.vin : "-"}
            </span>
          </div>
          <div>
            <h5 className="text-base font-poppins font-medium">
              Codice Motore
            </h5>
            <span className="text-base font-poppins font-light">
      ...
      <div className="flex flex-col gap-8">
        ...
        <div className="grid grid-cols-2 w-full gap-8">
          <div>
            <h5 className="text-base font-poppins font-medium">Trazione</h5>
            <span className="text-base font-poppins font-light">
          ...
          <div>
            <h5 className="text-base font-poppins font-medium">Potenza</h5>
            <span className="text-base font-poppins font-light">
          ...
          <div>
            <h5 className="text-base font-poppins font-medium">Spostamento</h5>
            <span className="text-base font-poppins font-light">
          ...
          <div>
            <h5 className="text-base font-poppins font-medium">Trasmissione</h5>
            <span className="text-base font-poppins font-light">
