        ...
        <div className="flex flex-col border-[3px] pl-10 pb-12 border-white gap-12">
          <div className="flex w-full items-center">
            <div className="flex flex-col w-1/2 gap-6">
              ...
              <span className="text-5xl font-poppins font-bold text-[#0BB489] underline">
          ...
          <span className="text-4xl text-white font-poppins font-light">
          ...
          <span className="text-4xl text-white font-poppins font-medium">
          ...
          <Button className="w-fit px-10 py-7 bg-[#0BB489] hover:bg-[#0BB489]/85">
            <span className="text-3xl text-white font-inter font-extrabold">
              REGISTRATI QUI!
            </span>
          </Button>
        </div>
